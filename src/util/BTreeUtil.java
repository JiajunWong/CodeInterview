...
/**
 * Created by Jiajun Wang on 8/5/16.
 */
public class BTreeUtil
{
    ...
    public static Node<Integer> generateRandomTree()
    {
    ...
    {
        if (nodes.isEmpty() || BTreeUtil.isAllElementsNull(nodes))
            return;
    ...
    private static <T extends Comparable<?>> int maxLevel(Node<T> node)
    {
        ...
        return Math.max(BTreeUtil.maxLevel(node.left), BTreeUtil.maxLevel(node.right)) + 1;
    }
